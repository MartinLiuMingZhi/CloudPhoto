...
class AwsS3Service(private val httpClient: HttpClient) : StorageService {
    ...
    override suspend fun uploadPhoto(
        ...
        try {
            ...
            val response = httpClient.put(url) {
                ...
                setBody(photoData)
                // AWS S3 requires AWS Signature V4, which is complex
                // For now, using basic approach - in production, use AWS SDK
            }
